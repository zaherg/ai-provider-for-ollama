...
1. On every push to `main`, `.github/workflows/auto-update-changelog.yml` refreshes `## [Unreleased]` in `CHANGELOG.md` from commit subjects since the latest release tag.
